...
@section('head')
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('core/css/laza.css') }}">
@endsection
...
<div class="align-items-sm-center"> 
    <form id="sendingserverCreate" action="{{ action('Store\ProductController@store') }}"  enctype="multipart/form-data" method="POST">
        {{ csrf_field() }}  
        @method('PUT')
    <div class="row">
